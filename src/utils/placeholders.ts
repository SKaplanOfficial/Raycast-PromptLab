...
const placeholders: PlaceholderList = {
  ...
  "{{musicAlbums}}": {
    ...
    fullRepresentation: "List of Music Albums",
  },
  ...
  "{{musicArtists}}": {
    ...
    fullRepresentation: "List of Music Artists",
  },
  ...
  "{{musicPlaylists}}": {
    ...
    fullRepresentation: "List of Music Playlists",
  },
  ...
  "{{tvDirectors}}": {
    ...
    fullRepresentation: "List of TV/Movie Directors",
  },
  ...
  "{{tvTracks}}": {
    ...
    fullRepresentation: "List of TV/Movie Tracks",
  },
  ...
  "{{tvPlaylists}}": {
    ...
    fullRepresentation: "List of TV/Movie Playlists",
  },
  ...
  "{{tvShows}}": {
    ...
    fullRepresentation: "List of TV Shows",
  },
  ...
  "{{currentTVTrack}}": {
    ...
    fullRepresentation: "Name of Current TV Track",
  },
  ...
  "{{photoAlbums}}": {
    ...
    fullRepresentation: "List of Photo Album Names",
  },
  ...
  "{{screenContent}}": {
    ...
    apply: async (str: string, context?: { [key: string]: string }) => {
      ...
      const overview = Context.filterString(
  ...
  "{{latitude}}": {
    ...
    fullRepresentation: "Current Latitude",
  },
  ...
  "{{longitude}}": {
    ...
    fullRepresentation: "Current Longitude",
  },
