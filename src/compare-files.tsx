...
export default function Command() {
    ...
    const basePrompt = "Compare and contrast the following texts. Format the response as one markdown paragraph.\n"
    ...
    if (commandError) {
        showToast({ title: "Failed File Comparison", message: commandError, style: Toast.Style.Failure })
        popToRoot()
        return
    }
